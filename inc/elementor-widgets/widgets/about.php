...
class Ariclaw_About extends Widget_Base {
	...
	protected function _register_controls() {
        ...
        $this->add_control(
			'about_img',
			[
				'label'         => esc_html__( 'Select Image', 'ariclaw' ),
        ...
        $this->add_control(
            'left_text',
            [
                'label'         => esc_html__( 'Left Text', 'ariclaw' ),
                'description'   => esc_html__('Use <br> tag for line break', 'ariclaw'),
                'type'          => Controls_Manager::WYSIWYG,
                'label_block'   => true,
                'default'       => __( '<h2>25 Years Working <br> Experience</h2>', 'ariclaw' )
            ]
        );
        $this->add_control(
            'content',
            [
                'label'         => esc_html__( 'Content', 'ariclaw' ),
                'description'   => esc_html__('Use <br> tag for line break', 'ariclaw'),
                'type'          => Controls_Manager::WYSIWYG,
                'label_block'   => true,
        ...
        $this->add_control(
            ...
            [
                ...
                'label_block'   => true,
                'default'       => esc_html__( 'learn more ', 'ariclaw' )
            ]
        );
        $this->add_control(
            'btnurl',
		...
		$this->add_control(
			'left_title', [
				'label'     => __( 'Left Title Color', 'ariclaw' ),
		...
		$this->add_control(
			'right_bigger_title', [
				'label'     => __( 'Right Bigger Title Color', 'ariclaw' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '#112e41',
				'selectors' => [
		...
		$this->add_control(
			'right_secondary_title', [
				'label'     => __( 'Right Secondary Title Color', 'ariclaw' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '#112e41',
				'selectors' => [
		...
		$this->add_control(
			'right_paragraph', [
				'label'     => __( 'Right Paragraph Color', 'ariclaw' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '#646464',
				'selectors' => [
	...
	protected function render() {
		...
		$feature_img  = !empty( $settings['about_img']['id'] ) ? wp_get_attachment_image( $settings['about_img']['id'], 'ariclaw_about_section_847x619', false, array( 'alt' => 'about image' ) ) : '';
        $icon_path_4 = ARICLAW_DIR_ASSETS_URI .'img/animate_icon/icon_4.png';
        $icon_path_5 = ARICLAW_DIR_ASSETS_URI .'img/animate_icon/icon_5.png';
        $icon_path_7 = ARICLAW_DIR_ASSETS_URI .'img/animate_icon/icon_7.png';
        ?>
