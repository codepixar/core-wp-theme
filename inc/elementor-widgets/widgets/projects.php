 ...
 * @since 1.0
 */
class Ariclaw_projects extends Widget_Base {

	public function get_name() {
		return 'ariclaw-projects';
	}

	public function get_title() {
		return __( 'Recent Works', 'ariclaw' );
	}
	...
	protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default'       => __( '<p>recent work</p><h2>Creative work for client</h2>', 'ariclaw' )
            ]
        );
        ...
        $this->start_controls_section(
            'menu_tab_sec',
            [
                'label' => __( 'Projects', 'ariclaw' ),
            ]
        );
        $this->add_control(
			'show_cat',
			[
				'label'         => __( 'Show Project Category', 'ariclaw' ),
				'type'          => Controls_Manager::SWITCHER,
				'label_on'      => __( 'Show', 'ariclaw' ),
				'label_off'     => __( 'Hide', 'ariclaw' ),
				'return_value'  => 'yes',
				'default'       => 'yes',
			]
		);
		$this->add_control(
			'excerpt_limit', [
				'label'         => esc_html__( 'Excerpt Limit', 'ariclaw' ),
		...
		$this->add_control(
			'portfolio_number', [
				'label'         => esc_html__( 'Project Number', 'ariclaw' ),
				'type'          => Controls_Manager::NUMBER,
				'max'           => 5,
				'min'           => 1,
				'step'          => 1,
        ...
        $this->add_control(
            'proj_title_color', [
                'label'     => __( 'Project Title Color', 'ariclaw' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#112e41',
                'selectors' => [
        ...
        $this->add_control(
            'proj_text_color', [
                'label'     => __( 'Project Text Color', 'ariclaw' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#646464',
                'selectors' => [
        ...
        $this->add_control(
            'learn_more_color', [
                'label'     => __( 'Learn More Color', 'ariclaw' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#112e41',
                'selectors' => [
    ...
    <section class="our_latest_work section_padding">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <?php
                        ariclaw_portfolio_section( $pNumber, $excerpt_limit, $show_cat );
                    ?>
                </div>
            </div>
        </div>
