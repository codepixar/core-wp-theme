	...
	protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'label_block'   => true,
                'default'       => __( '<p>Team Member</p><h2>Talest & Experienced Team</h2>', 'ariclaw' )
            ]
        );
            ...
            'teams_content', [
                ...
                'fields' => [
                    ...
                    [
                        ...
                        'label_block' => true,
                        'default' => __( 'Jhosef Williams', 'ariclaw' )
                    ],
                    [
                        'name'      => 'desg',
                        'label'     => __( 'Designation', 'ariclaw' ),
                        'type'      => Controls_Manager::TEXT,
                        'default'   => __( 'Web developer', 'ariclaw' )
                    ],
                    [
                        'name'      => 'fb',
        ...
        $this->add_control(
            'color_secttitle', [
                'label'     => __( 'Team Left Title Color', 'ariclaw' ),
            ...
            <div class="row justify-content-center">
                ...
                if( is_array( $teams ) && count( $teams ) > 0 ){
                    foreach ( $teams as $team ) {
                        $team_img   = !empty( $team['image']['id'] ) ? wp_get_attachment_image( $team['image']['id'], 'ariclaw_team_img_320x309', false, array( 'alt' => $team['label'] ) ) : '';
                    ...
                    <div class="single_team_member">
                        ...
                        <div class="single_team_text">
                            ...
                            <div class="team_member_social_icon">
                                <a href="<?php echo esc_url( $fb );?>"><?php echo esc_html( 'facebook', 'ariclaw' );?></a>
                                <a href="<?php echo esc_url( $tw );?>"><?php echo esc_html( 'twitter', 'ariclaw' );?></a>
                                <a href="<?php echo esc_url( $skp );?>"><?php echo esc_html( 'skype', 'ariclaw' );?></a>
                            </div>
                        </div>
                    </div>
                </div>
