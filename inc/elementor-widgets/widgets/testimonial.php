	...
	protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'label_block'   => true,
                'default'       => __( 'Testimonials', 'ariclaw' )
            ]
        );
        $this->add_control(
            'sec_subtitle', [
                ...
                'type'          => Controls_Manager::TEXT,
                'label_block'   => true,
                'default'       => esc_html__( 'Client says about me', 'ariclaw' )
		...
		$this->start_controls_section(
			'section_intro_vid',
			[
				'label' => __( 'Section Intro Video', 'ariclaw' ),
			]
		);
        $this->add_control(
            'intro_vid_title',
            ...
            'review_slider', [
                ...
                'fields' => [
                    ...
                    [
                        ...
                        moveth. Fifth shall wont signs, can seasons green days gathered great', 'ariclaw')
                    ],
                    [
                        'name'  => 'client_logo',
                        'label' => __( 'Client Logo', 'ariclaw' ),
                        'type'  => Controls_Manager::MEDIA,
                    ],
                    [
                        'name'  => 'label',
        ...
        $this->add_control(
            'intro_vid_bg',
            [
                'label'     => __( 'Intro Video Background Settings', 'ariclaw' ),
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'intro-video-bg',
                'label' => __( 'Intro Video Background', 'ariclaw' ),
        ...
        $this->add_control(
            'section_bgheading',
            [
                'label'     => __( 'Section Background Settings', 'ariclaw' ),
                'type'      => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
                        ...
                        <div class="row">
                                ...
                                <div class="owl-carousel owl-theme" id="sync2">
                                    ...
                                    if( is_array( $reviews ) && count( $reviews ) > 0 ){
                                        foreach ($reviews as $review ) {
                                            $image = !empty( $review['client_img']['id'] ) ? wp_get_attachment_image( $review['client_img']['id'], 'ariclaw_review_client_img_160x160', '', array('class' => 'image','alt' => $review['label'] ) ) : '';
                                        ?>
                            ...
                            <div class="col-lg-12">
                                <div class="slider owl-carousel owl-theme" id="sync1">
                                    ...
                                    if( is_array( $reviews ) && count( $reviews ) > 0 ){
                                        foreach ($reviews as $review ) {
                                            $image = !empty( $review['client_logo']['id'] ) ? wp_get_attachment_image( $review['client_logo']['id'], 'ariclaw_review_client_logo_115x68', '', array('class' => 'image','alt' => $review['label'] ) ) : '';
